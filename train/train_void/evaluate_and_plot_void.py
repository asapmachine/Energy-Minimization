...
def main():
    ...
    model.load_model('catboost_mof_void_predictor_best.cbm')
    ...
    ax1.set_xlabel("真实值 (Actual void)", fontsize=12)
    ax1.set_ylabel("预测值 (Predicted void)", fontsize=12)
    ...
    ax2.set_xlabel("void 值", fontsize=12)
    ...
    # 保存逻辑
    save_filename = r'E:\CODE\cif2des\train_void\final_result\FINAL_Plot_300dpi.png'

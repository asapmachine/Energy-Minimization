...
def main():
    ...
    model.load_model('catboost_mof_GSA_predictor_best.cbm')
    ...
    ax1.set_xlabel("真实值 (Actual GSA, $m^2/g$)", fontsize=12)
    ax1.set_ylabel("预测值 (Predicted GSA, $m^2/g$)", fontsize=12)
    ...
    ax2.set_xlabel("GSA 值 ($m^2/g$)", fontsize=12)
    ...
    # 保存逻辑
    save_filename = r'E:\CODE\cif2des\train_GSA\final_result\FINAL_Plot_300dpi.png'

...
def main():
    print("步骤一：正在加载数据...")
    df = pd.read_csv(r'E:\CODE\cif2des\train_Di\clean_data\train_data_Di_final.csv')
    ...
    model.load_model('catboost_mof_di_predictor_best.cbm')
    ...
    ax1.set_xlabel("真实值 (Actual Di)", fontsize=12)
    ax1.set_ylabel("预测值 (Predicted Di)", fontsize=12)
    ...
    ax2.set_xlabel("Di 值", fontsize=12)
    ...
    # 保存逻辑
    save_filename = r'E:\CODE\cif2des\train_Di\final_result\FINAL_Plot_300dpi.png'

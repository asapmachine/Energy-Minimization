...
target_col = 'Dif'        # 替换为你表格中代表“优化后Di”的真实列名
...
# 调整布局并保存/显示
plt.tight_layout()
plt.savefig(r'E:\CODE\cif2des\train_Dif\property_png\Dif_distribution_analysis_3.png', dpi=300)
print("\n分布图已保存为 'Dif_distribution_analysis.png'。")
plt.show()
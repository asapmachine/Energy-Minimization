...
def main():
    ...
    model.load_model('catboost_mof_dif_predictor_best.cbm')
    ...
    ax1.set_xlabel("真实值 (Actual Dif)", fontsize=12)
    ax1.set_ylabel("预测值 (Predicted Dif)", fontsize=12)
    ...
    ax2.set_xlabel("Dif 值", fontsize=12)
    ...
    # 保存逻辑
    save_filename = r'E:\CODE\cif2des\train_Dif\final_result\FINAL_Plot_300dpi.png'

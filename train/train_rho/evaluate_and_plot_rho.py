...
def main():
    print("步骤一：正在加载数据...")
    df = pd.read_csv(r'E:\CODE\cif2des\train_rho\clean_data\train_data_rho_final.csv')
    ...
    model.load_model('catboost_mof_rho_predictor_best.cbm')
    ...
    ax1.set_xlabel("真实值 (Actual rho)", fontsize=12)
    ax1.set_ylabel("预测值 (Predicted rho)", fontsize=12)
    ...
    ax2.set_xlabel("rho 值", fontsize=12)
    ...
    # 保存逻辑
    save_filename = r'E:\CODE\cif2des\train_rho\final_result\FINAL_Plot_300dpi.png'

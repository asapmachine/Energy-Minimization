...
def clean_zero_values_with_summary(input_csv, output_csv):
    ...
    # 2. 定义目标列
    columns_to_check = ['Df', 'Di', 'GSA', 'VSA', 'rho_x']
...
if __name__ == "__main__":
    input_file = r'E:\CODE\cif2des\train_rho\clean_data\train_data_rho.csv'
    output_file = r'E:\CODE\cif2des\train_rho\clean_data\train_data_rho_final.csv'

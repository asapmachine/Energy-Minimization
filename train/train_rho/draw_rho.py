...
target_col = 'rho'        # 替换为你表格中代表“优化后Di”的真实列名
...
# 调整布局并保存/显示
plt.tight_layout()
plt.savefig(r'E:\CODE\cif2des\train_rho\property_png\rho_distribution_analysis.png', dpi=300)
print("\n分布图已保存为 'rho_distribution_analysis.png'。")
plt.show()
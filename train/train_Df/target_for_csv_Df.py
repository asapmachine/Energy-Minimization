...
if __name__ == "__main__":
    # 请根据你实际的文件路径进行替换
    file_a = r'E:\CODE\cif2des\calc\clean_data\merged_features.csv'
    # 数据源表 B, C, D 的路径列表
    ...
    matched_target_file = r'E:\CODE\cif2des\train_Df\clean_data_Df\train_data_Df.csv'
    
    # 没匹配上的 30 个文件单独存放在这里，供人工排查
    unmatched_error_file = r'E:\CODE\cif2des\train_Df\clean_data_Df\unmatched_30_error.csv'

...
def main():
    print("=============== 1. 加载数据与严格对齐 ===============")
    # ⚠️ 请修改为你的 Df 训练集实际路径
    csv_path = r'E:\CODE\cif2des\train\train_Df\clean_data_Df\train_data_Df_final.csv'
    model_path = 'catboost_mof_Df_predictor_best.cbm' # 你的模型路径
    ...
    # 修改标题与物理单位
    ax2.set_title("机器学习预测 (CatBoost: $Df_{pred}$ vs $Df_{opt}$)", fontsize=14, pad=15)
    ...
    if not os.path.exists(out_dir):
        os.makedirs(out_dir)
    save_path = f"{out_dir}/Df_Baseline_vs_ML_Comparison.png"

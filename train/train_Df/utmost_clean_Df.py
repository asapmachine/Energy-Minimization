...
def clean_zero_values_with_summary(input_csv, output_csv):
    ...
    # 2. 定义目标列
    columns_to_check = ['Df_x', 'Di', 'GSA', 'VSA', 'rho']
...
if __name__ == "__main__":
    input_file = r'E:\CODE\cif2des\train_Df\clean_data_Df\train_data_Df.csv'
    output_file = r'E:\CODE\cif2des\train_Df\clean_data_Df\train_data_Df_second.csv'

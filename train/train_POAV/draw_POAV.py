...
# 1. 配置参数 (请根据你的实际情况修改)
# ==========================================
csv_path = r'E:\CODE\cif2des\calc\clean_data\goal_data\final_ABC_features_optimal.csv'  # 替换为你实际的优化后特征 CSV 文件路径
target_col = 'POAV'        # 替换为你表格中代表“优化后Di”的真实列名
...
# 调整布局并保存/显示
plt.tight_layout()
plt.savefig(r'E:\CODE\cif2des\train_POAV\property_png\poav_distribution_analysis.png', dpi=300)
print("\n分布图已保存为 'poav_distribution_analysis.png'。")
plt.show()
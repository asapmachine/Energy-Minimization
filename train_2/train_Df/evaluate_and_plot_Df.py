...
def main():
    ...
    df = pd.read_csv(r'E:\CODE\cif2des\train_2\train_Df\clean_data\A_final_cleaned_data_racs.csv')
    ...
    model.load_model('catboost_mof_df_predictor_best_with_RACs.cbm')
    ...
    ax1.set_xlabel("真实值 (Actual Df, Å)", fontsize=12)
    ax1.set_ylabel("预测值 (Predicted Df, Å)", fontsize=12)
    ...
    ax2.set_xlabel("Df 值 (Å)", fontsize=12)

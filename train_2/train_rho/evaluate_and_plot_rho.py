...
def main():
    ...
    df = pd.read_csv(r'E:\CODE\cif2des\train_2\train_rho\clean_data\A_final_cleaned_data.csv')
    ...
    model.load_model('catboost_mof_rho_predictor_best_with_RACs.cbm')
    ...
    ax1.set_xlabel("真实密度 (Actual rho, g/cm³)", fontsize=12)
    ax1.set_ylabel("预测密度 (Predicted rho, g/cm³)", fontsize=12)
    ...
    ax2.set_xlabel("rho 值 (g/cm³)", fontsize=12)
    ...
    out_dir = r'E:\CODE\cif2des\train_2\train_rho\final_result'

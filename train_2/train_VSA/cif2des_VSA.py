...
# 【关键保护】：只在“几何特征”和“目标Y”上执行严格的 dropna
...
def objective(trial):
    param = {
        ...
        'depth': trial.suggest_int('depth', 5, 9),  # 稍降树深上限，防止高维过拟合
        'l2_leaf_reg': trial.suggest_float('l2_leaf_reg', 1.0, 50.0), # 放宽正则上限
...
print(f"真实 MAE:  {final_mae:.4f} m^2/cm^3")  # VSA单位
print(f"真实 RMSE: {final_rmse:.4f} m^2/cm^3")
...
final_model.save_model('catboost_mof_VSA_predictor_best_with_RACs.cbm')
print("✅ 带有 RACs 的最佳高维模型已安全落盘 (catboost_mof_VSA_predictor_best_with_RACs.cbm)！")
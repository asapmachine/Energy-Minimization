...
def main():
    ...
    df = pd.read_csv(r'E:\CODE\cif2des\train_2\train_Dif\clean_data\A_final_cleaned_data.csv')
    ...
    model.load_model('catboost_mof_dif_predictor_best_with_RACs.cbm')
    ...
    ax1.set_xlabel("真实值 (Actual Dif, Å)", fontsize=12)
    ax1.set_ylabel("预测值 (Predicted Dif, Å)", fontsize=12)
    ...
    ax2.set_xlabel("Dif 值 (Å)", fontsize=12)
    ...
    out_dir = r'E:\CODE\cif2des\train_2\train_Dif\final_result'

...
def objective(trial):
    param = {
        ...
        'l2_leaf_reg': trial.suggest_float('l2_leaf_reg', 1.0, 50.0), # 扩大上限防过拟合
...
final_model.save_model('catboost_mof_dif_predictor_best_with_RACs.cbm')
print("✅ 最佳高维模型已安全落盘 (catboost_mof_dif_predictor_best_with_RACs.cbm)！")
...
final_model.load_model('catboost_mof_di_predictor_best_with_RACs.cbm')
...
print("正在计算测试集的 SHAP 值，请稍候 (高维数据计算可能需要一小会儿)...")
...
# 使用 max_display=20 确保只显示最重要的 20 个特征，避免 150+ 特征堆叠导致图表无法阅读

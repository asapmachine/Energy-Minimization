...
X = df[valid_features]
print("正在对目标变量 GSA_y 进行对数转换 (log1p)...")
...
print(f"\n🎯 终极盲测 (物理真实尺度) -> R2: {final_r2:.4f} | MAE: {final_mae:.4f} m²/g | RMSE: {final_rmse:.4f} m²/g")

final_model.save_model('catboost_mof_GSA_predictor_best_with_RACs.cbm')
print("✅ 最佳高维模型已安全落盘 (catboost_mof_GSA_predictor_best_with_RACs.cbm)！")
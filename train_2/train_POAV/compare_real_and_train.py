...
def main():
    print("=============== 1. 加载数据与严格对齐 ===============")
    csv_path = r'E:\CODE\cif2des\train_2\train_POAV\clean_data\A_final_cleaned_data.csv'
    model_path = 'catboost_mof_POAV_predictor_best_with_RACs.cbm' 
    ...
    print("\n" + "🔥" * 25)
    print("     物理形变基准 vs 高维机器学习预测 对比报告 (POAV)")
    print("🔥" * 25)
    ...
    ax2.set_title("高维机器学习预测 (ML+RACs: $POAV_{pred}$ vs $POAV_{opt}$)", fontsize=14, pad=15)
    ...
    if not os.path.exists(out_dir):
        os.makedirs(out_dir)
    save_path = f"{out_dir}/POAV_Baseline_vs_ML_Comparison_with_RACs.png"

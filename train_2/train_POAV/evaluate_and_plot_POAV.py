...
def main():
    ...
    df = pd.read_csv(r'E:\CODE\cif2des\train_2\train_POAV\clean_data\A_final_cleaned_data.csv')

    geo_features = ['Di', 'Df', 'Dif', 'rho', 'VSA', 'GSA', 'VPOV', 'GPOV', 'POAV_vol_frac', 'GPOAV', 'POAV_x']
    rac_features = [
    ...
    model.load_model('catboost_mof_POAV_predictor_best_with_RACs.cbm')
    ...
    ax1.set_xlabel("真实值 (Actual POAV, Å³)", fontsize=12)
    ax1.set_ylabel("预测值 (Predicted POAV, Å³)", fontsize=12)
    ...
    ax2.set_xlabel("POAV 值 (Å³)", fontsize=12)
    ...
    out_dir = r'E:\CODE\cif2des\train_2\train_POAV\final_result'

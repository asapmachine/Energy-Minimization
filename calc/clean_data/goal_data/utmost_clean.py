...
def clean_zero_values_with_summary(input_csv, output_csv):
    ...
    # 2. 定义目标列
    columns_to_check = ['Df', 'Di_x', 'GSA', 'VSA', 'rho']
...
if __name__ == "__main__":
    input_file = r'E:\CODE\cif2des\train_Di\clean_data\train_data_Di.csv'
    output_file = r'E:\CODE\cif2des\train_Di\clean_data\train_data_Di_final.csv'

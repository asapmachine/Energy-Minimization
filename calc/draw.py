...
# 1. 配置参数 (请根据你的实际情况修改)
# ==========================================
csv_path = r'E:\MOF database\zenodo_upload_ultrastable\zenodo_upload_ultrastable\features_and_predictions(features)\ultrastable\RAC_and_geom_2inor_1edge.csv'  # 替换为你实际的优化后特征 CSV 文件路径
target_col = 'Df'        # 替换为你表格中代表“优化后Df”的真实列名
...
# 调整布局并保存/显示
plt.tight_layout()
plt.savefig(r'E:\CODE\cif2des\property_png\Df_distribution_analysis_3.png', dpi=300)
print("\n分布图已保存为 'Df_distribution_analysis.png'。")
plt.show()